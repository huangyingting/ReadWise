/**
 * Runtime speech timing, tokenization, and audio-time helpers.
 *
 * Stored payload parsing and serialization live in timing-storage.ts so Reader
 * callers do not depend on migration formats.
 */
