 ...
 *
 * Pure functions for computing WPM (words per minute) from active reading
 * time and article word count, plus a trend helper that aggregates across
 * multiple mastery records. Keeps this file free of DB imports so the
