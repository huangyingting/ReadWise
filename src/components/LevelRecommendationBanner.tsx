...
export default function LevelRecommendationBanner({
  ...
  if (applied) {
    return (
      <div
        role="status"
        className="flex items-center gap-[var(--space-3)] p-[var(--space-4)] rounded-[var(--radius-lg)] border border-border bg-surface mb-[var(--space-6)]"
      >
  ...
  return (
    <div
      ...
      className="flex items-start gap-[var(--space-3)] p-[var(--space-4)] rounded-[var(--radius-lg)] border border-border bg-surface mb-[var(--space-6)]"
    >
      <div
