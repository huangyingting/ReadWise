...
> Last generated: 2026-07-22T09:12:18.667Z
...
| `/api/assignments/{id}` | PATCH | 200 | assignment | — | dueDate, instructions, points, studentIds, title |
...
| `/api/classrooms/{id}/assignments` | POST | 201 | assignment | — | articleId, dueDate, instructions, points, studentIds, title |
| `/api/classrooms/{id}/assignments/bulk` | POST | 201 | created, failed | — | articleIds, dueDate, instructions, points, studentIds |
