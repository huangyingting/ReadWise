...
> Last generated: 2026-07-22T09:39:17.172Z

**140 routes · 170 method handlers**
...
| `/api/assignments/{id}` | GET | 🔐 session | `P` | 200 | JSON |  |  |
...
| `/api/assignments/{id}/completions/{studentId}` | PATCH | 🔐 session | `B` `P` | 200 | JSON |  |  |
| `/api/assignments/{id}/remind` | POST | 🔐 session | `P` | 200 | JSON |  |  |
| `/api/assignments/{id}/reopen` | POST | 🔐 session | `P` | 200 | JSON |  |  |
...
| `/api/classrooms` | GET | 🔐 session | `Q` | 200 | JSON |  |  |
...
| `/api/classrooms/{id}/assignments/bulk` | POST | 🔐 session | `B` `P` | 201 | JSON |  |  |
...
| `/api/orgs/{id}/members` | POST | 🔐 session | `B` `P` | 200 | JSON |  |  |
...
| `/api/reader/{id}/speech/audio` | GET | 🔐 session | `P` | 206 | binary | nodejs |  |
...
| `/api/assignments/{id}` | GET | 200 | assignment | — | — |
| `/api/assignments/{id}` | DELETE | 200 | ok | — | — |
| `/api/assignments/{id}` | PATCH | 200 | assignment | — | dueDate, instructions, points, publishAt, publishState, studentIds, title |
| `/api/assignments/{id}/completion` | POST | 201 | completion, ok | — | quizScore, status |
| `/api/assignments/{id}/completions/{studentId}` | PATCH | 200 | completion | — | feedback, pointsAwarded |
| `/api/assignments/{id}/remind` | POST | 200 | result | — | — |
| `/api/assignments/{id}/reopen` | POST | 200 | result | — | — |
| `/api/bookmarks/membership` | GET | 200 | lists | — | — |
| `/api/bookmarks/toggle` | POST | 200 | bookmarked | — | — |
| `/api/classrooms` | GET | 200 | classrooms | archived | — |
...
| `/api/classrooms/{id}/assignments` | POST | 201 | assignment | — | articleId, dueDate, instructions, points, publishAt, publishState, studentIds, title |
| `/api/classrooms/{id}/assignments/bulk` | POST | 201 | created, failed | — | articleIds, dueDate, instructions, points, publishAt, publishState, studentIds |
...
| `/api/orgs/{id}/members` | POST | 200 | membership, ok | — | role, userId |
...
| `/api/reader/{id}/speech` | POST | 200 | audioUrl | — | — |
